...
export const resetPasswordEmailTemplate = (url: string) => `
    ...
    <p>Hello,</p>
    <p>We received a request to reset your password for your Quokka account. Click the button below to reset it:</p>
    ...
    <p>Best regards,<br>The Quokka Team</p>
...
export const sendEmail = async ({
  ...
  return resend.emails.send({
    from: isDev ? "onboarding@resend.dev" : "Quokka <hello@quokka.gg>",
